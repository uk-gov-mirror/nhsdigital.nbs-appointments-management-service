...
public class BookingCosmosDocumentStoreTests
{
    ...
    public async Task GetCrossSiteAsync_ShouldFilterOnStatus()
    {
        ...
        {
            new() { Reference = "test-1", Status = AppointmentStatus.Booked, AvailabilityStatus = AvailabilityStatus.Unknown, ContactDetails = [] },
            new() { Reference = "test-3", Status = AppointmentStatus.Booked, AvailabilityStatus = AvailabilityStatus.Unknown, ContactDetails = [] },
        };
