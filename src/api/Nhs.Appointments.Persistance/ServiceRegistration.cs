...
public static class ServiceRegistration
{
    ...
    public static IServiceCollection AddDocumentStores(this IServiceCollection services)
    {
        services
            ...
            .AddScoped<ICoreReferenceMigrationNumberDocumentStore, CoreCoreReferenceGroupCosmosDocumentStore>()
            .AddScoped<ICoreReferenceNumberDocumentStore, CoreCoreReferenceGroupCosmosDocumentStore>()
