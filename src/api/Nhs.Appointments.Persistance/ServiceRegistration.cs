...
public static class ServiceRegistration
{
    ...
    public static IServiceCollection AddDocumentStores(this IServiceCollection services)
    {
        services
            ...
            .AddScoped<IBookingReferenceNumberDocumentStore, BookingReferenceGroupCosmosDocumentStore>()
            .AddScoped<ICoreReferenceNumberMigrationDocumentStore, CoreCoreReferenceNumberGroupCosmosDocumentStore>()
            .AddScoped<ICoreReferenceNumberDocumentStore, CoreCoreReferenceNumberGroupCosmosDocumentStore>()
